...
namespace benzinotomasyonu
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            depo_bilgileri[2] = Convert.ToString(D_eurodizel);
            depo_bilgileri[3] = Convert.ToString(D_dizel);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                F_eurodizel = F_eurodizel + (F_eurodizel * Convert.ToDouble(textBox8.Text) / 100);
                fiyat_bilgileri[2] = Convert.ToString(D_eurodizel);
            }
            catch (Exception)
            {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (comboBox1.Text == "Euro Dziel")
            {
                numericUpDown1.Enabled = false;
                numericUpDown2.Enabled = false;
                numericUpDown3.Enabled = false;
            ...
            label29.Text = "_________________";
        ...
        private void progressBAr_guncelle()
        {
            ...
            progressBar3.Value=Convert.ToInt16(D_eurodizel);
            progressBar4.Value = Convert.ToInt16(D_dizel);
        ...
        private void numericupdown_value()
        {
            ...
            numericUpDown3.Maximum = decimal.Parse(D_eurodizel.ToString());
            numericUpDown4.Maximum = decimal.Parse(D_dizel.ToString());
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string[] yakit_turleri = { "BEnzin(95)", "Benzin(97)", "Dizel", "Euro Dziel", "Lpg" };
            ...
            //her tiklamada ne kadar artacak
